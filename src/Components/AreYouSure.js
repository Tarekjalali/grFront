...
const AreYouSure = () => {
  ...
  return (
    <div>
      {/* Flowbite Button to toggle the modal */}
     
        <ListItemButton disablePadding onClick={openModal}> Delete Account </ListItemButton>
              ...
              <div className="p-4 md:p-5 text-center">
                ...
                <div className="flex justify-center space-x-4">
                  <button 
                    ...
                    onClick={() => dispatch(deleteAccount(user._id, navigate))}
                  >
                    Yes, I'm sure
                  </button>
                  <button
